                    ...
                    .map(pr => (
                      <tr key={`${pr.id}-${pr.rowIndex}`} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-8 py-4 text-center">
                          <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-tighter ${pr.status?.includes('WAITING') ? 'bg-amber-50 text-amber-600 border border-amber-100' :
